           ...
           case 'guardar_antes':
            case 'iniciar_campo':
                $rules = [
                    ...
                    'tipo' => ['nullable', 'string', Rule::in(['NUEVO SUMINISTRO', 'INCREMENTO', 'TRASLADO'])],
            ...
            case 'guardar_durante':
             case 'finalizar_campo':
                $rules = [
                    ...
                    'num_poste' => ['nullable', 'numeric', 'max:999999.99'],
                    ...
                    'cantidad_suministros' => ['nullable', 'numeric', 'max:999999.99'],
                    'suministro_existente' => ['nullable', 'numeric', 'max:999999.99'],
