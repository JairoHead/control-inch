        ...
        <div class="bg-white dark:bg-gray-800 shadow-xl rounded-lg overflow-hidden">
            <div class="p-6 sm:p-8">
                ...
                <div class="mb-6 pb-4 border-b border-gray-200">
                    <h1 class="text-2xl font-bold text-center">Editar Usuario: {{ $user->name }}</h1>
                </div>
                ...
                <form action="{{ route('admin.users.update', $user) }}" method="POST enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email', $user->email) }}" class="form-input w-full" required>
                        </div>
                        <div>
                            <label for="password" class="form-label">Nueva Contraseña <span class="text-gray-500 text-xs">(Opcional)</span></label>
                            <input id="password" type="password" name="password" class="form-input w-full" placeholder="Dejar en blanco para no cambiar">
                        </div>
                        <div>
                    ...
                    <div class="flex items-center justify-end mt-8 pt-6 border-t border-gray-200 space-x-3">
                        ...
                        <button class="form-button-primary" type="submit">Actualizar Usuario</button>
                    </div>
                </form>
            </div>
        </div>
