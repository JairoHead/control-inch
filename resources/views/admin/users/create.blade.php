                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="mt-2 flex items-center gap-x-4">
                                <img src="{{ $user->profile_photo_path ? asset('storage/' . $user->profile_photo_path) : asset('images/default-avatar.png') }}" alt="{{ $user->name }}" class="h-24 w-24 rounded-full object-cover">
