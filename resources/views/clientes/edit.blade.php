            ...
            <div class="p-6 sm:p-8">
                ...
                <div class="mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 text-center">
                        Editar Cliente: {{ $cliente->nombre_completo ?? ($cliente->nombres . ' ' . $cliente->apellido_paterno) }}
                    </h1>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input class="form-input @error('dni') input-error @enderror w-full"
                                   id="dni" type="text" name="dni" value="{{ old('dni', $cliente->dni) }}"
                        ...
                        <div>
                            ...
                            <input class="form-input @error('nombres') input-error @enderror w-full"
                                   id="nombres" type="text" name="nombres" value="{{ old('nombres', $cliente->nombres) }}" required>
                        ...
                        <div>
                            ...
                            <input class="form-input @error('apellido_paterno') input-error @enderror w-full"
                                   id="apellido_paterno" type="text" name="apellido_paterno" value="{{ old('apellido_paterno', $cliente->apellido_paterno) }}" required>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input class="form-input @error('apellido_materno') input-error @enderror w-full"
                                   id="apellido_materno" type="text" name="apellido_materno" value="{{ old('apellido_materno', $cliente->apellido_materno) }}" required>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input class="form-input @error('nro_celular') input-error @enderror w-full"
                                   id="nro_celular" type="text" name="nro_celular" value="{{ old('nro_celular', $cliente->nro_celular) }}"
