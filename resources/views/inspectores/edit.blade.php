            ...
            <div class="p-6 sm:p-8">
                ...
                <div class="mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 text-center">
                        Editar Inspector: {{ $inspector->nombre_completo ?? ($inspector->nombres . ' ' . $inspector->apellido_paterno) }}
                    </h1>
                </div>
                ...
                @if ($errors->any())
                    <div class="mb-4 p-4 bg-red-100 border-l-4 border-red-500 text-red-700 dark:bg-red-900 dark:border-red-700 dark:text-red-300 rounded-md" role="alert">
                         {{-- ... (contenido de errores sin cambios) ... --}}
                         <div class="flex">
                ...
                <form action="{{ route('inspectores.update', $inspector) }}" method="POST">
                    @csrf
                    @method('PATCH') {{-- O PUT --}}

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                        {{-- ============================================ --}}
                        {{-- INICIO: CAMPO DNI MODIFICADO               --}}
                        {{-- ============================================ --}}
                        <div class="md:col-span-2">
                            ...
                            <input class="form-input @error('dni') input-error @enderror w-full"
                                   id="dni" type="text" name="dni" value="{{ old('dni', $inspector->dni) }}"
                        ...
                        <div>
                            ...
                            <input class="form-input @error('nombres') input-error @enderror w-full"
                                   id="nombres" type="text" name="nombres" value="{{ old('nombres', $inspector->nombres) }}" required>
                        ...
                        <div>
                            ...
                            <input class="form-input @error('apellido_paterno') input-error @enderror w-full"
                                   id="apellido_paterno" type="text" name="apellido_paterno" value="{{ old('apellido_paterno', $inspector->apellido_paterno) }}" required>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input class="form-input @error('apellido_materno') input-error @enderror w-full"
                                   id="apellido_materno" type="text" name="apellido_materno" value="{{ old('apellido_materno', $inspector->apellido_materno) }}" required>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input class="form-input @error('nro_celular') input-error @enderror w-full"
                                   id="nro_celular" type="text" name="nro_celular" value="{{ old('nro_celular', $inspector->nro_celular) }}"
                    ...
                    <div class="flex items-center justify-end mt-8 pt-6 border-t border-gray-200 dark:border-gray-700 space-x-3">
                        <a href="{{ route('inspectores.index') }}" class="form-button-secondary">
                            Cancelar
                        </a>
